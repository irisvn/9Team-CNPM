...
final class Alg_WC_Custom_Payment_Gateways {
	...
	function admin() {
		...
		$this->settings['input_fields'] = require_once( 'includes/settings/class-alg-wc-custom-payment-gateways-settings-input-fields.php' );
		$this->settings['fees']         = require_once( 'includes/settings/class-alg-wc-custom-payment-gateways-settings-fees.php' );
		$this->settings['advanced']     = require_once( 'includes/settings/class-alg-wc-custom-payment-gateways-settings-advanced.php' );
		// Version update
